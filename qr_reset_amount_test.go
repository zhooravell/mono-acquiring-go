...
func TestQrResetAmount(t *testing.T) {
	...
	mux.HandleFunc("/api/merchant/qr/reset-amount", func(w http.ResponseWriter, req *http.Request) {
	...
	assert.NoError(t, client.QrResetAmount(context.Background(), QrResetAmountRequest{QrID: "p2_9ZgpZVsl3"}))
}

func TestQrResetAmount_Validation(t *testing.T) {
...
func TestQrResetAmount_NetworkError(t *testing.T) {
	...
	for name, val := range tests {
		t.Run(name, func(t *testing.T) {
			...
			err = client.QrResetAmount(context.Background(), QrResetAmountRequest{QrID: val.QrID})
